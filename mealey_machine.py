...
class MooreMachineSimulator:
    def __init__(self, root):
        ...
        button = tk.Button(root, text="Simüle Et", bg="#CFEEDC", fg="white", font=("Helvetica", 12, "bold"))
        button.pack(pady=20)
    ...
    def add_labeled_entry(self, parent, label_text, attribute_name):
        ...
        entry.configure(background="#CFEEDC")  # Arka plan rengini burada değiştiriyoruz
    ...
    def add_labeled_text(self, parent, label_text, attribute_name):
        ...
        label.pack(pady=5)
        text = tk.Text(parent, height=7, width=70, background="#CFEEDC", wrap=tk.WORD)  # Arka plan rengini burada da değiştiriyoruz
        text.pack(pady=5)
